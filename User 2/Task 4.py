...
plt.figure(figsize=(8, 6))
sns.scatterplot(x='books_per_year', y='english_skills', data=df, marker='o')

# Add labels and title
plt.xlabel('books_per_year')
plt.ylabel('english_skills')
plt.title('Scatter Plot: books per year vs English skills')
